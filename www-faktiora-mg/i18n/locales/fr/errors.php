...
return [
    'catch' => [
        ...
        //entree - filter autre entree admin
        'entree_filterAutreEntreeAdmin' => DEBUG ? "Erreur dans entree/filterAutreEntreeAdmin : :field" : "Une erreur est survenue lors de listage des autres entrées",
    ],
    'not_found' => [
