...
return [
    'titles' => [
        ...
        'effective_client_user' => 'Effectif des clients et utilisateurs par genre',
        ...
        'delete_user' => 'Suppression des utilisateurs',
        'deconnect_user' => 'Déconnection des utilisateurs',
        'print_all_user' => 'Rapport des utilisateurs',
        ...
        'cash_delete' => "Suppression des caisses",
        ...
        'update_ligne_caisse' => "Modification de la ligne de caisse",
        'delete_ligne_caisse' => "Suppression des lignes de caisse",
        ...
        'delete_client' => "Suppression des clients",
        ...
        'facture_delete' => "Suppresion des factures",
        'facture_restore' => "Récupération des factures",
        'ligne_facture' => "Lignes de facture",
        'facture_update' => "Modification de la facture",
        ...
        'ae_correction_inflow' => "Correction de l'autre entrée (entrée)",
        'ae_correction_outflow' => "Correction de l'autre entrée (sortie)",
        'ae_delete' => "Suppréesion des autres entrées",
        ...
        'sortie_update' => "Modification de la sortie",
        'sortie_correction_inflow' => "Correction de la sortie (entrée)",
        'sortie_correction_outflow' => "Correction de la sortie (sortie)",
        'sortie_delete' => "Suppression des sorties",
        ...
        'produit_update' => "Modification du produit",
        'produit_delete' => "Suppression des produits",
        ...
        'article_delete' => "Suppression des articles",
    ...
    'labels' => [
        ...
        'login' => 'E-mail ou numéro du compte',
