...
return [
    'invalids' => [
        //
        'nom' => "Le <b>nom</b> ne doit pas dépasser 100 caractères.",
        'prenoms' => "Le <b>prénoms</b> ne doit pas dépasser 100 caractères.",
        'sexe' => "Sexe invalide : <b>:field</b>.",
        'email' => "Adresse e-mail invalide : <b>:field</b>.",
        'email_length' => "L'adresse <b>e-mail</b> ne doit pas dépasser 150 caractères.",
        'role' => "Rôle invalide : <b>:field</b>.",
        'mdp' => "Le <b>mot de passe</b> doit contenir au moins 6 caractères.",
        'mdp_confirm' => "Le mot de passe de confirmation doît être identique au mot de passe.",
        'from_to' => "La date de début ne doit pas dépasser la date de fin.",
        'date' => "Date invalide : <b>:field</b>.",
        'solde' => "Le solde doit être une valeur décimale supérieure ou égale à 0.",
        'seuil' => "Le seuil doît être une valeur décimale supérieure ou égaule à 0.",
        'solde_seuil' => "Le solde ne doit pas être inférieur au seuil.",
        'date_future' => "La date de doit pas être dans le futur.",
        'date_fusion' => "Les dates choisies ne sont pas valides : elles se chevauchent.",
        'libelle' => "Le libellé ne doit pas dépasser 100 caractères.",
        'montant' => "Le montant doit être une valeur décimale supérieure à 0.",
        'prix' => "Le prix doit être une valeur décimale supérieure à 0.",
        'nb_stock' => "Le nombre de stock ne doit pas être inférieur à 0.",
        'telephone' => "Numéro de téléphone invalide : <b>:field</b>.",
        'adresse' => "L'adresse ne doit pas dépasser 100 caractères.",
        'correction_quantite' => "Quantité invalide pour la ligne ayant l'ID <b>:field</b> : la quantité de correction ne doit pas dépasser la quantité originale.",
        ...
        //user - id user
        'user_id_user' => "L'ID de l'utilisateur invalide : <b>:field</b>.",
        //user - deleted
        'user_deleted' => "L'utilisateur avec l'ID <b>:field</b> a déjà été supprimé.",
        //caisse - num_caisse
        'caisse_num_caisse' => "Le numéro de caisse doît être une valeur entiere supérieure ou égale à 0.",
        //caisse - not selected
        ...
        //caisse - id lc
        'caisse_id_lc' => "Le numéro de la ligne de caisse doit être une valeur entière supérieure ou égale à 1.",
        //caisse - occuped
        'caisse_occuped' => "La caisse numéro <b>:field</b> est encore occupéé.",
        //caisse - deleted
        'caisse_deleted' => "La caisse numéro <b>:field</b> a déjà été supprimée.",
        //caisse - occupCaisse
        'caisse_occupCaisse' => "Seuls les caissiers peuvent occuper les caisses.",
        //caisse - date_fin reopen
        'caisse_date_fin_reopen' => "Une ligne fermée ne peut pas être rouverte.",
        //caisse - line open / user id
        'caisse_line_open_user_id' => "La ligne est encore ouverte, vous ne pouvez pas modifier l'ID de l'utilisateur pour le moment.",
        ...
        //entree - ae deleted
        'entree_ae_deleted' => "L'autre entrée numéro <b>:field</b> a déjà été supprimée.",
        ...
        'entree_facture_id_lf' => "La ligne de facture avec l'ID <b>:id_lf</b> n'appartient pas à la facture numéro <b>:num_facture</b>.",
        //entree - facture lf id_produit
        'entree_facture_lf_id_produit' => "Le produit avec l'ID <b>:id_produit</b> n'appartient pas à la ligne de facture avec l'ID <b>:id_lf</b>.",
        //entree - facture deleted
        'entree_facture_deleted' => "La facture numéro <b>:field</b> a déjà été supprimée.",
        ...
        //produit - deleted
        'produit_deleted' => "Le produit avec l'ID <b>:field</b> a déjà été supprimé.",
        //produit - nb stock less
        'produit_nb_stock_less' => "Le nombre de stock n'est pas suffisant pour le produit avec l'ID <b>:id_produit</b>, stock restant : <b>:nb_stock</b>.",
        ...
        //article - deleted
        'article_deleted' => "L'article avec l'ID <b>:field</b> a déjà été supprimé.",
        ...
        //sortie - deleted
        'sortie_deleted' => "La sortie numéro <b>:field</b> a déjà été supprimée.",
        ...
        //client  - deleted
        'client_deleted' => "Le client avec l'ID <b>:field</b> a déjà été supprimé.",
        //auth - login empty
        'auth_login_empty' => "Veuiller entrer votre numéro de compte ou e-mail.",
        //auth - password empty
    ...
    'success' => [
        ...
        //user - update user
        'user_update' => "Les informations de l'utilisateur avec l'ID <b>:field</b> ont été modifiées avec succès.",
        //user - delete account
        'user_deleteAccount' => "Compte supprimé avec succès.",
        //user - delete all 0
        'user_deleteAll_0' => "Aucun utilisateur n'a été supprimé.",
        //user - delete all 1
        ...
        'user_deconnectAll_0' => "Aucun utilisateur n'a été déconnecté.",
        //user - deconnect all 1
        'user_deconnectAll_1' => "Un utilisateur a été déconnecté avec succès.",
        //user - deconnect all plur
        'user_deconnectAll_plur' => "<b>:field</b> utilisateurs ont été déconnectés avec succès.",
        //user - signup
        'user_signup' => "Compte crée avec succès. Redirection vers la page de connexion.",
        //user - restore all user 0
        'user_restoreAllUser_0' => "Aucun utilisateur n'a été récupéré.",
        ...
        'caisse_updateCaisse' => "Les informations de la caisse numéro <b>:field</b> ont été modifiées avec succès.",
        //caisse - delete all 0
        'caisse_deleteAll_0' => "Aucune caisse n'a été supprimée.",
        //caisse - delete all 1
        ...
        'caisse_deleteAllLigneCaisse_0' => "Aucune ligne de caisse n'a été supprimée.",
        ...
        'caisse_addLigneCaisse' => "Ligne de caisse ajoutée avec succès.",
        //caisse - occup caisse
        'caisse_occupCaisse' => "Caisse numéro <b>:field</b> a été occupée avec succès.",
        //caisse - quit caisse
        'caisse_quitCaisse' => "Caisse libérée avec succès.",
        //caisse - free caisse 0
        'caisse_freeCaisse_0' => "Aucune caisse n'a été libérée.",
        ...
        'caisse_updateLigneCaisse' => "Ligne de caisse numéro <b>:field</b> a été modifiée avec succès.",
        //caisse - restore all caisse 0
        'caisse_restoreAllCaisse_0' => "Aucune caisse n'a été récupéree.",
        ...
        'entree_deleteAllAutreEntree_0' => "Aucune autre entrée n'a été supprimée.",
        ...
        'entree_createLigneFacture' => "Nouvelle ligne de facture créée avec succès.",
        //entree - update facture
        'entree_updateFacture' => "La facture numéro <b>:field</b> a été modifiée avec succès.",
        //entree - delete all facture 0
        'entree_deleteAllFacture_0' => "Aucune facture n'a été supprimée.",
        ...
        'entree_restoreAllFacture_0' => "Aucune facture n'a été récupérée.",
        ...
        'entree_restoreAllFacture_plur' => "<b>:field</b> factures ont été récupérées avec succès.",
        //entree - restore all entree 0
        'entree_restoreAllAutreEntree_0' => "Aucune autre entrée n'a été récupérée.",
        ...
        'entree_restoreAllAutreEntree_plur' => "<b>:field</b> autres entrées ont été récupérées avec succès.",
        //produit - create produit
        'produit_createProduit' => "Nouveau produit ajouté avec succès.",
        //produit - update produit
        'produit_updateProduit' => "Le produit avec l'ID <b>:field</b> a été modifié avec succès.",
        //produit - delete all produit 0 
        'produit_deleteAllProduit_0' => "Aucun produit n'a été supprimé.",
        ...
        'produit_restoreAllProduit_0' => "Aucun produit n'a été récupéré.",
        ...
        'article_deleteAllArticle_0' => "Aucun article n'a été supprimé.",
        ...
        'article_restoreAllArticle_0' => "Aucun article n'a été récupéré.",
        ...
        'sortie_createLigneDs' => "Nouvele ligne de sortie créée avec succès.",
        //sortie - create sortie
        'sortie_createSortie' => "Nouvelle sortie ajoutée avec succès.",
        //sortie - update demande sortie 
        'sortie_updateDemandeSortie' => "Sortie numéro <b>:field</b> a été modifiée avec succès.",
        //sortie - delete all demande sortie 0
        'sortie_deleteAllDemandeSortie_0' => "Aucune sortie n'a été supprimée.",
        ...
        'sortie_correctionFacture_not_corrected' => "Aucune correction n'a été faite pour cette facture.",
        //sortie - restore all demande sortie 0
        'sortie_restoreAllDemandeSortie_0' => "Aucune sortie n'a été récupérée.",
        ...
        'client_deleteAllClient_0' => "Aucun client n'a été supprimé.",
        //client - delete all client 1
        'client_deleteAllClient_1' => "Un client a été supprimé avec succès.",
        //client - delete all client plur
        'client_deleteAllClient_plur' => "<b>:field</b> clients on été supprimés avec succès.",
        //client - restore all client 0
        'client_restoreAllClient_0' => "Aucun client n'a été récupéré.",
    ...
    'not_found' => [
        ...
        //user - email
        'user_email' => "L'utilisateur avec l'adresse e-mail <b>:field</b> n'existe pas.",
        //caisse - num_caisse
        'caisse_num_caisse' => "La caisse numéro <b>:field</b> n'existe pas.",
        //caisse - id lc
        'caisse_id_lc' => "La ligne de caisse avec l'ID <b>:field</b> n'existe pas.",
        //entree - num_ae
        'entree_num_ae' => "L'autre entrée numéro <b>:field</b> n'existe pas.",
        //entree - num_facture
        'entree_num_facture' => "La facture numéro <b>:field</b> n'existe pas.",
        //entree - id lf
        'entree_id_lf' => "La ligne de facture avec l'ID <b>:field</b> n'existe pas.",
        //produit - id_produit
    ...
    'duplicate' => [
        //user - email
        'user_email' => "L'adresse e-mail <b>:field</b> existe déjà.",
        //caisse - num_caisse
        'caisse_num_caisse' => "La caisse numéro <b>:field</b> existe déjà.",
        //caisse - id_lc
        'caisse_id_lc' => "La ligne de caisse avec l'ID <b>:field</b> existe déjà.",
        //entree - num_ae
        'entree_num_ae' => "L'autre entrée numéro <b>:field</b> existe déjà.",
    ]
];
