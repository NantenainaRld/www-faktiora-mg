...
class EntreeController extends Controller
{
    ...
    //page - autre_entree dashboard
    public function pageAutreEntree()
    {
        //is loged in ?
        ...
        if ($is_loged_in->getLoged()) {
            ...
            $_SESSION['menu'] = 'autre_entree';
            $this->render('autre_entree_dashboard', [
                'title' => 'Faktiora - ' . __('forms.titles.autre_entree_dashboard'),
    ...
    public function filterAe()
    {
        ...
        //filter autre entree
        $response = AutreEntree::filterAe($params);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
            ...
            try {
                ...
                if (!$response['found']) {
                    $response = [
                        'message_type' => 'invalid',
                        'message' => __('messages.not_found.entree_num_facture', ['field' => $json['num_ds']])
                    ];
                ...
                $facture_model
                    ...
                    ->setDateFacture($json['date_facture']);
