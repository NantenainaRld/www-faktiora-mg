document.addEventListener("DOMContentLoaded", async () => {
  ...
  setTimeout(async () => {
    ...
    //======================= UPDATE USER ==========================
    //modal update user
    const modalUpdateUser = container.querySelector("#modal-update-user");
